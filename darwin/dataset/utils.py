...
def _validate_inputs(
    partition: Union[str, None], split_type: str, annotation_type: str
) -> None:
    """
...
def _get_annotation_filepaths_from_split(
    ...
    """
    Determines the filepaths based on the dataset split and other parameters.
...
def _map_annotations_to_images(
    ...
    """
    Maps annotations to their corresponding images based on their filepaths
