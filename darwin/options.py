...
class Options(object):
    def __init__(self):
        ...
        parser_import.add_argument(
            "--append", action="store_true", help="Append annotations instead of overwriting")
        ...
        parser_files.add_argument(
            "--status", type=str, required=False, help="Comma separated list of statuses")
        parser_files.add_argument("--path", type=str, required=False, help="")
        parser_files.add_argument(
            "--sort-by", type=str, required=False, help="Sort remotely fetched files by the given attribute and direction. Defaults to 'updated_at:desc'.")
        ...
        parser_file_status.add_argument(
            "status", type=str, help="Status to change to")
        parser_file_status.add_argument(
            "files", type=str, nargs="+", help="Files to change status")
        # Help
        dataset_action.add_parser(
