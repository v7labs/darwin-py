...
from darwin.future.data_objects.team import TeamModel, get_team
...
class Team(MetaBase[TeamModel]):
    ...
    def __init__(self, client: CoreClient, team: Optional[TeamModel] = None) -> None:
