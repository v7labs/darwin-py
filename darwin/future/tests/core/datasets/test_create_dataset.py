...
def test_it_creates_a_dataset(basic_dataset: DatasetModel, base_client: CoreClient) -> None:
...
def test_it_raises_an_error_on_http_error(basic_dataset: DatasetModel, base_client: CoreClient) -> None:
