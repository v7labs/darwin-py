...
def test_team_member_collects_basic(base_client: ClientCore, base_team_members_json: List[dict]) -> None:
...
def test_team_member_only_passes_back_correct(base_client: ClientCore, base_team_member_json: dict) -> None:
    query = TeamMemberQuery(base_client)
    with responses.RequestsMock() as rsps:
        endpoint = base_client.config.api_endpoint + "memberships"
...
def test_team_member_filters_general(base_client: ClientCore, base_team_members_json: List[dict]) -> None:
