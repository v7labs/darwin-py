...
@fixture
def base_meta_team(base_client: CoreClient, base_team: TeamModel) -> Team:
    return Team(base_client, base_team)


@fixture
def base_meta_workflow(base_client: CoreClient, base_workflow: WorkflowModel) -> Workflow:
    return Workflow(base_client, base_workflow)


@fixture
def base_meta_stage(base_client: CoreClient, base_stage: WFStageModel, base_UUID: UUID) -> Stage:
