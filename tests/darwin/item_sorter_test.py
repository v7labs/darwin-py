...
def describe_item_sorter():
    def describe_parse():
        def test_works_when_sort_is_complete_and_valid():
            sort = "updated_at:asc"
        ...
        def test_works_when_sort_is_partial_and_valid():
            sort = "updated_at"
        ...
        def test_raises_when_sort_has_invalid_format():
        ...
        def test_raises_when_sort_has_invalid_field():
            field = "asdf"
            sort = f"{field}:asc"
...
def describe_sort_direction():
    def describe_parse():
        def test_returns_asc_enum_when_given_asc_direction():
            short_direction = "asc"
        ...
        def test_returns_desc_enum_when_given_desc_direction():
        ...
        def test_raises_when_direction_is_invalid():
